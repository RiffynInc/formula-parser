...
var grammarParser = function () {
    var o = function o(k, v, _o, l) {
        ...
        $Vg = [1, 23],
        $Vh = [1, 24],
        $Vi = [5, 9, 10, 11, 13, 14, 15, 16, 17, 18, 19, 20, 24, 25],
        $Vj = [5, 9, 10, 11, 13, 14, 15, 16, 17, 18, 19, 20, 24, 25, 27],
        $Vk = [5, 9, 10, 11, 13, 14, 15, 16, 17, 18, 19, 20, 24, 25, 29],
        $Vl = [5, 10, 11, 13, 14, 15, 16, 17, 24, 25],
        $Vm = [5, 10, 13, 14, 15, 16, 24, 25],
        $Vn = [5, 10, 11, 13, 14, 15, 16, 17, 18, 19, 24, 25],
        $Vo = [13, 24, 25];
